 ...
 *)
Theorem OBS_PAR_TAU_TAU = Q.SPEC `tau` OBS_PAR_PREF_TAU
 ...
 *)
Theorem OBS_RESTR_PREFIX_LABEL =
  ((Q.GENL [`l`, `L`]) o
   (DISCH ``~((l :'a Label) IN L) /\ ~((COMPL l) IN L)``) o
   (Q.GEN `E`) o
   UNDISCH)
