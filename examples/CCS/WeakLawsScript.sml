 ...
 *)
Theorem WEAK_EQUIV_SUBST_SUM_L =
    Q.GENL [`E`, `E'`]
     (DISCH_ALL
      (Q.GEN `E''`
       (OE_TRANS
 ...
 *)
Theorem WEAK_PAR_TAU_TAU = Q.SPEC `tau` WEAK_PAR_PREF_TAU
 ...
 *)
Theorem WEAK_PAR_PREF_NO_SYNCR =
 ...
 *)
Theorem WEAK_RESTR_PREFIX_LABEL =
    GEN_ALL
       (DISCH ``~((l :'a Label) IN L) /\ ~((COMPL l) IN L)``
        (Q.GEN `E`
         (UNDISCH
