...
Definition EXPLICIT_ACCEPT_COND_SEM_TIME_def:
...
Definition EXPLICIT_ACCEPT_COND_SEM_def:
...
*****************************************************************************)
Definition EXPLICIT_ACCEPT_FALSE_def:   EXPLICIT_ACCEPT_FALSE = EXPLICIT_ACCEPT_NOT(EXPLICIT_ACCEPT_TRUE)
End
Definition EXPLICIT_ACCEPT_F_def:       EXPLICIT_ACCEPT_F b = EXPLICIT_ACCEPT_NOT(EXPLICIT_ACCEPT_G (EXPLICIT_ACCEPT_NOT b))
End
Definition EXPLICIT_ACCEPT_OR_def:      EXPLICIT_ACCEPT_OR(b1, b2) = EXPLICIT_ACCEPT_NOT(EXPLICIT_ACCEPT_AND(EXPLICIT_ACCEPT_NOT b1, EXPLICIT_ACCEPT_NOT b2))
End
Definition EXPLICIT_ACCEPT_IMPL_def:    EXPLICIT_ACCEPT_IMPL(b1, b2) = EXPLICIT_ACCEPT_OR(EXPLICIT_ACCEPT_NOT b1, b2)
End
Definition EXPLICIT_ACCEPT_EQUIV_def:   EXPLICIT_ACCEPT_EQUIV(b1, b2) = EXPLICIT_ACCEPT_AND(EXPLICIT_ACCEPT_IMPL(b1, b2),EXPLICIT_ACCEPT_IMPL(b2, b1))
End
Definition EXPLICIT_ACCEPT_GF_def:       EXPLICIT_ACCEPT_GF b = EXPLICIT_ACCEPT_G(EXPLICIT_ACCEPT_F b)
End
Definition EXPLICIT_ACCEPT_FG_def:       EXPLICIT_ACCEPT_FG b = EXPLICIT_ACCEPT_F(EXPLICIT_ACCEPT_G b)
End


Definition EXPLICIT_ACCEPT_COND_USED_INPUT_VARS_def:
...
Definition EXPLICIT_ACCEPT_COND_USED_STATE_VARS_def:
...
Definition IS_EXPLICIT_PROP_ACCEPT_COND_def:
...
Definition EXPLICIT_PROP_ACCEPT_COND_SEM_def:
...
Definition EXPLICIT_ACCEPT_COND___STATE_VAR_RENAMING_def:
