...
Definition CTL_STAR_SEM_PATH_def:
...
Definition CTL_STAR_SEM_STATE_def:
...
Definition CTL_STAR_KS_SEM_def:
   CTL_STAR_KS_SEM M f = (!s. P_SEM s M.S0 ==> CTL_STAR_SEM_STATE M f s)
End


Definition IS_CTL_STAR_PATH_FORMULA_def:
...
Definition IS_CTL_STAR_STATE_FORMULA_def:
...
Definition IS_CTL_STAR_PROP_FORMULA_def:
...
Definition CTL_STAR_USED_VARS_def:
...
Definition CTL_STAR_SEM_NO_MODEL_PATH_TIME_def:
...
Definition CTL_STAR_SEM_NO_MODEL_PATH_def:
...
* Syntactic Sugar
******************************************************************************)
Definition CTL_STAR_A_def:   CTL_STAR_A f = CTL_STAR_NOT (CTL_STAR_E(CTL_STAR_NOT f))
End
Definition CTL_STAR_OR_def:   CTL_STAR_OR(f1,f2) = CTL_STAR_NOT (CTL_STAR_AND((CTL_STAR_NOT f1),(CTL_STAR_NOT f2)))
End
Definition CTL_STAR_IMPL_def:   CTL_STAR_IMPL(f1, f2) = CTL_STAR_OR(CTL_STAR_NOT f1, f2)
End
Definition CTL_STAR_COND_def:   CTL_STAR_COND(c, f1, f2) = CTL_STAR_AND(CTL_STAR_IMPL(c, f1), CTL_STAR_IMPL(CTL_STAR_NOT c, f2))
End
Definition CTL_STAR_EQUIV_def:   CTL_STAR_EQUIV(b1, b2) = CTL_STAR_AND(CTL_STAR_IMPL(b1, b2),CTL_STAR_IMPL(b2, b1))
End
Definition CTL_STAR_EVENTUAL_def:   CTL_STAR_EVENTUAL f = CTL_STAR_SUNTIL (CTL_STAR_PROP(P_TRUE),f)
End
Definition CTL_STAR_ALWAYS_def:   CTL_STAR_ALWAYS f = CTL_STAR_NOT (CTL_STAR_EVENTUAL (CTL_STAR_NOT f))
End
Definition CTL_STAR_UNTIL_def:   CTL_STAR_UNTIL(f1,f2) = CTL_STAR_OR(CTL_STAR_SUNTIL(f1,f2),CTL_STAR_ALWAYS f1)
End
Definition CTL_STAR_BEFORE_def:   CTL_STAR_BEFORE(f1,f2) = CTL_STAR_NOT(CTL_STAR_SUNTIL(CTL_STAR_NOT f1,f2))
End
Definition CTL_STAR_SBEFORE_def:   CTL_STAR_SBEFORE(f1,f2) = CTL_STAR_SUNTIL(CTL_STAR_NOT f2,CTL_STAR_AND(f1, CTL_STAR_NOT f2))
End
Definition CTL_STAR_WHILE_def:   CTL_STAR_WHILE(f1,f2) = CTL_STAR_NOT(CTL_STAR_SUNTIL(CTL_STAR_OR(CTL_STAR_NOT f1, CTL_STAR_NOT f2),CTL_STAR_AND(f2, CTL_STAR_NOT f1)))
End
Definition CTL_STAR_SWHILE_def:   CTL_STAR_SWHILE(f1,f2) = CTL_STAR_SUNTIL(CTL_STAR_NOT f2,CTL_STAR_AND(f1, f2))
End
Definition CTL_STAR_PEVENTUAL_def:   CTL_STAR_PEVENTUAL f = CTL_STAR_PSUNTIL (CTL_STAR_PROP(P_TRUE),f)
End
Definition CTL_STAR_PALWAYS_def:   CTL_STAR_PALWAYS f = CTL_STAR_NOT (CTL_STAR_PEVENTUAL (CTL_STAR_NOT f))
End
Definition CTL_STAR_PUNTIL_def:   CTL_STAR_PUNTIL(f1,f2) = CTL_STAR_OR(CTL_STAR_PSUNTIL(f1,f2),CTL_STAR_PALWAYS f1)
End
Definition CTL_STAR_PNEXT_def:   CTL_STAR_PNEXT f = CTL_STAR_NOT(CTL_STAR_PSNEXT (CTL_STAR_NOT f))
End
Definition CTL_STAR_PBEFORE_def:   CTL_STAR_PBEFORE(f1,f2) = CTL_STAR_NOT(CTL_STAR_PSUNTIL(CTL_STAR_NOT f1,f2))
End
Definition CTL_STAR_PSBEFORE_def:   CTL_STAR_PSBEFORE(f1,f2) = CTL_STAR_PSUNTIL(CTL_STAR_NOT f2,CTL_STAR_AND(f1, CTL_STAR_NOT f2))
End
Definition CTL_STAR_PWHILE_def:   CTL_STAR_PWHILE(f1,f2) = CTL_STAR_NOT(CTL_STAR_PSUNTIL(CTL_STAR_OR(CTL_STAR_NOT f1, CTL_STAR_NOT f2),CTL_STAR_AND(f2, CTL_STAR_NOT f1)))
End
Definition CTL_STAR_PSWHILE_def:   CTL_STAR_PSWHILE(f1,f2) = CTL_STAR_PSUNTIL(CTL_STAR_NOT f2,CTL_STAR_AND(f1, f2))
End

Definition CTL_STAR_FAIRNESS_def:
...
Definition CTL_STAR_FAIR_E_def:   CTL_STAR_FAIR_E FC f = (CTL_STAR_E (CTL_STAR_AND(f, CTL_STAR_FAIRNESS FC)))
End
Definition CTL_STAR_FAIR_A_def:   CTL_STAR_FAIR_A FC f = (CTL_STAR_A (CTL_STAR_IMPL(CTL_STAR_FAIRNESS FC, f)))
End
...
Definition LTL_TO_CTL_STAR_def:
...
Definition FAIR_CTL_TO_CTL_STAR_def:
...
(*Syntactic Sugaring*)
Definition FAIR_CTL_OR_def:   FAIR_CTL_OR(f1,f2) = FAIR_CTL_NOT (FAIR_CTL_AND((FAIR_CTL_NOT f1),(FAIR_CTL_NOT f2)))
End
Definition FAIR_CTL_IMPL_def:   FAIR_CTL_IMPL(f1, f2) = FAIR_CTL_OR(FAIR_CTL_NOT f1, f2)
End
Definition FAIR_CTL_COND_def:   FAIR_CTL_COND(c, f1, f2) = FAIR_CTL_AND(FAIR_CTL_IMPL(c, f1), FAIR_CTL_IMPL(FAIR_CTL_NOT c, f2))
End
Definition FAIR_CTL_EQUIV_def:   FAIR_CTL_EQUIV(b1, b2) = FAIR_CTL_AND(FAIR_CTL_IMPL(b1, b2),FAIR_CTL_IMPL(b2, b1))
End
Definition FAIR_CTL_A_NEXT_def:   FAIR_CTL_A_NEXT FC f = FAIR_CTL_NOT(FAIR_CTL_E_NEXT FC (FAIR_CTL_NOT f))
End
Definition FAIR_CTL_E_EVENTUAL_def:   FAIR_CTL_E_EVENTUAL FC f = FAIR_CTL_E_SUNTIL FC (FAIR_CTL_PROP(P_TRUE),f)
End
Definition FAIR_CTL_E_ALWAYS_def:   FAIR_CTL_E_ALWAYS FC f = FAIR_CTL_E_UNTIL FC (f, FAIR_CTL_PROP(P_FALSE))
End
Definition FAIR_CTL_A_EVENTUAL_def:   FAIR_CTL_A_EVENTUAL FC f = FAIR_CTL_NOT (FAIR_CTL_E_ALWAYS FC (FAIR_CTL_NOT f))
End
Definition FAIR_CTL_A_ALWAYS_def:   FAIR_CTL_A_ALWAYS FC f = FAIR_CTL_NOT (FAIR_CTL_E_EVENTUAL FC (FAIR_CTL_NOT f))
End
Definition FAIR_CTL_A_UNTIL_def:   FAIR_CTL_A_UNTIL FC (f1,f2) = FAIR_CTL_NOT(FAIR_CTL_E_SUNTIL FC (FAIR_CTL_NOT f2, (FAIR_CTL_AND(FAIR_CTL_NOT f1, FAIR_CTL_NOT f2))))
End
Definition FAIR_CTL_A_SUNTIL_def:   FAIR_CTL_A_SUNTIL FC (f1,f2) = FAIR_CTL_NOT(FAIR_CTL_E_UNTIL FC (FAIR_CTL_NOT f2, (FAIR_CTL_AND(FAIR_CTL_NOT f1, FAIR_CTL_NOT f2))))
End
Definition FAIR_CTL_E_BEFORE_def:   FAIR_CTL_E_BEFORE FC (f1,f2) = FAIR_CTL_E_UNTIL FC (FAIR_CTL_NOT f2, FAIR_CTL_AND(f1, FAIR_CTL_NOT f2))
End
Definition FAIR_CTL_E_SBEFORE_def:   FAIR_CTL_E_SBEFORE FC (f1,f2) = FAIR_CTL_E_SUNTIL FC (FAIR_CTL_NOT f2, FAIR_CTL_AND(f1, FAIR_CTL_NOT f2))
End
Definition FAIR_CTL_A_BEFORE_def:   FAIR_CTL_A_BEFORE FC (f1,f2) = FAIR_CTL_NOT(FAIR_CTL_E_SUNTIL FC (FAIR_CTL_NOT f1, f2))
End
Definition FAIR_CTL_A_SBEFORE_def:   FAIR_CTL_A_SBEFORE FC (f1,f2) = FAIR_CTL_NOT(FAIR_CTL_E_UNTIL FC (FAIR_CTL_NOT f1, f2))
End
Definition FAIR_CTL_E_WHILE_def:   FAIR_CTL_E_WHILE FC (f1,f2) = FAIR_CTL_E_UNTIL FC (FAIR_CTL_NOT f2, FAIR_CTL_AND(f1, f2))
End
Definition FAIR_CTL_E_SWHILE_def:   FAIR_CTL_E_SWHILE FC (f1,f2) = FAIR_CTL_E_SUNTIL FC (FAIR_CTL_NOT f2, FAIR_CTL_AND(f1, f2))
End
Definition FAIR_CTL_A_WHILE_def:   FAIR_CTL_A_WHILE FC (f1,f2) = FAIR_CTL_NOT(FAIR_CTL_E_SUNTIL FC (FAIR_CTL_NOT f2, FAIR_CTL_AND(FAIR_CTL_NOT f1, f2)))
End
Definition FAIR_CTL_A_SWHILE_def:   FAIR_CTL_A_SWHILE FC (f1,f2) = FAIR_CTL_NOT(FAIR_CTL_E_UNTIL FC (FAIR_CTL_NOT f2, FAIR_CTL_AND(FAIR_CTL_NOT f1, f2)))
End
...
Definition CTL_TO_FAIR_CTL_def:
...
Definition CTL_FALSE_def:   CTL_FALSE = CTL_PROP P_FALSE
End
Definition CTL_TRUE_def:   CTL_TRUE = CTL_PROP P_TRUE
End
Definition CTL_OR_def:   CTL_OR(f1,f2) = CTL_NOT (CTL_AND((CTL_NOT f1),(CTL_NOT f2)))
End
Definition CTL_IMPL_def:   CTL_IMPL(f1, f2) = CTL_OR(CTL_NOT f1, f2)
End
Definition CTL_COND_def:   CTL_COND(c, f1, f2) = CTL_AND(CTL_IMPL(c, f1), CTL_IMPL(CTL_NOT c, f2))
End
Definition CTL_EQUIV_def:   CTL_EQUIV(b1, b2) = CTL_AND(CTL_IMPL(b1, b2),CTL_IMPL(b2, b1))
End
Definition CTL_A_NEXT_def:   CTL_A_NEXT f = CTL_NOT(CTL_E_NEXT (CTL_NOT f))
End
Definition CTL_E_EVENTUAL_def:   CTL_E_EVENTUAL f = CTL_E_SUNTIL (CTL_PROP(P_TRUE),f)
End
Definition CTL_E_ALWAYS_def:   CTL_E_ALWAYS f = CTL_E_UNTIL (f, CTL_PROP(P_FALSE))
End
Definition CTL_A_EVENTUAL_def:   CTL_A_EVENTUAL f = CTL_NOT (CTL_E_ALWAYS (CTL_NOT f))
End
Definition CTL_A_ALWAYS_def:   CTL_A_ALWAYS f = CTL_NOT (CTL_E_EVENTUAL (CTL_NOT f))
End
Definition CTL_A_UNTIL_def:   CTL_A_UNTIL(f1,f2) = CTL_NOT(CTL_E_SUNTIL(CTL_NOT f2, (CTL_AND(CTL_NOT f1, CTL_NOT f2))))
End
Definition CTL_A_SUNTIL_def:   CTL_A_SUNTIL(f1,f2) = CTL_NOT(CTL_E_UNTIL(CTL_NOT f2, (CTL_AND(CTL_NOT f1, CTL_NOT f2))))
End
Definition CTL_E_BEFORE_def:   CTL_E_BEFORE(f1,f2) = CTL_E_UNTIL(CTL_NOT f2, CTL_AND(f1, CTL_NOT f2))
End
Definition CTL_E_SBEFORE_def:   CTL_E_SBEFORE(f1,f2) = CTL_E_SUNTIL(CTL_NOT f2, CTL_AND(f1, CTL_NOT f2))
End
Definition CTL_A_BEFORE_def:   CTL_A_BEFORE(f1,f2) = CTL_NOT(CTL_E_SUNTIL(CTL_NOT f1, f2))
End
Definition CTL_A_SBEFORE_def:   CTL_A_SBEFORE(f1,f2) = CTL_NOT(CTL_E_UNTIL(CTL_NOT f1, f2))
End
Definition CTL_E_WHILE_def:   CTL_E_WHILE(f1,f2) = CTL_E_UNTIL(CTL_NOT f2, CTL_AND(f1, f2))
End
Definition CTL_E_SWHILE_def:   CTL_E_SWHILE(f1,f2) = CTL_E_SUNTIL(CTL_NOT f2, CTL_AND(f1, f2))
End
Definition CTL_A_WHILE_def:   CTL_A_WHILE(f1,f2) = CTL_NOT(CTL_E_SUNTIL(CTL_NOT f2, CTL_AND(CTL_NOT f1, f2)))
End
Definition CTL_A_SWHILE_def:   CTL_A_SWHILE(f1,f2) = CTL_NOT(CTL_E_UNTIL(CTL_NOT f2, CTL_AND(CTL_NOT f1, f2)))
End
