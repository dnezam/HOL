...
Theorem LTL_TO_GEN_BUECHI_DS___SEM___CONTRADICTION___KRIPKE_STRUCTURE =
    SIMP_RULE std_ss [LTL_TO_GEN_BUECHI_DS___A_NDET___IS_EMPTY___TO___KRIPKE_STRUCTURE_EMPTY]
    LTL_TO_GEN_BUECHI_DS___SEM___CONTRADICTION___MAX

Theorem LTL_TO_GEN_BUECHI_DS___SEM___GEN_CONTRADICTION___KRIPKE_STRUCTURE =
    SIMP_RULE std_ss [LTL_TO_GEN_BUECHI_DS___A_NDET___IS_EMPTY___TO___KRIPKE_STRUCTURE_EMPTY]
    LTL_TO_GEN_BUECHI_DS___SEM___GEN_CONTRADICTION___MAX
...
Theorem EXTEND_IV_BINDING_LTL_TO_GEN_BUECHI_DS___REWRITES =
